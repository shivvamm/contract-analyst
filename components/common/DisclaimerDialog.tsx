...
export function DisclaimerDialog() {
  ...
  useEffect(() => {
    if (settings.disclaimerAcknowledged) return;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-near-black/60 backdrop-blur-sm">
      <div ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="disclaimer-title" className="bg-surface rounded-[var(--radius-container)] ring-miro p-8 max-w-md w-full mx-4 shadow-xl">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 id="disclaimer-title" className="text-card-title text-near-black">Legal Disclaimer</h2>
        </div>
